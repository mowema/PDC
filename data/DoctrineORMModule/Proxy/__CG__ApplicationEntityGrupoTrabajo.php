 ...
 */
class GrupoTrabajo extends \Application\Entity\GrupoTrabajo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'descripcion', 'fecha_creacion', 'fecha_modificado', 'estado', 'usuario_c', 'usuario_m', 'grupo', 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GrupoTrabajo $proxy) {
