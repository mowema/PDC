...
return array(
    ...
    "The input does not appear to be a valid datetime" => "Lo ingresado no tiene formato de fecha",
    ...
    "The input does not fit the date format '%format%'" => "Se espera el siguiente format: DD-MM-AAAA",
...
// Zend_Validate_GreaterThan
    ...
    "The input is not less than '%max%'" => "Valor demasiado largo",
    "The input is not less or equal than '%max%'" => "Valor demasiado largo",
    ...
    "Invalid type given. String expected" => "El tipo especificado es incorrecto, el valor deberí­a ser una cadena de texto",
    "The input is less than %min% characters long" => "texto demasiado corto",
    "The input is more than %max% characters long" => "texto demasiado extenso",
