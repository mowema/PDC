...
return array(
    'router' => array(
        'routes' => array(
            ...
            'r' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/r[/:action][/:id][/grupo/:grupo][/controlador/:controlador][/informe/:informe][/apapelera/:apapelera][/page/:page]',
                    'constraints' => array(
                        'action' => '(?!\bpage\b)[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
                    ...
                    'defaults' => array(
                        'controller' => 'Application\Controller\R',
                        'action' => 'index',
                    ),
                ),
            ),
            'dist' => array(
                ...
                'options' => array(
                    ...
                    'defaults' => array(
                        'controller' => 'Application\Controller\Dist',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Application\Controller\R' => 'Application\Controller\RegistroController',
            'Application\Controller\Dist' => 'Application\Controller\DistribuidorController',
        ...
        'rule_providers' => array(
            'BjyAuthorize\Provider\Rule\Config' => array(
                'allow' => array(
                    ...
                    array(array('Administrador'), array('gestionRegistro','usuarios', 'roles','reporte','crud'), array('crear', 'editar', 'apapelera', 'informe', 'index', 'pdf')),
                    array(array('Gestor'), array('gestionRegistro'), array('crear','editar', 'index', 'apapelera')),
                    ),
